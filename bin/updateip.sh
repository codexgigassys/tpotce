...
sed -i "s#SSH:.*#SSH: ssh -l tsec -p 7014 $myLOCALIP[0m#" /etc/issue
sed -i "s#WEB:.*#WEB: https://$myLOCALIP:7017[0m#" /etc/issue
sed -i "s#ADMIN:.*#ADMIN: https://$myLOCALIP:7012[0m#" /etc/issue
